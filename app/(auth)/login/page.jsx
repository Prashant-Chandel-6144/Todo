...
function PasswordField({ label, placeholder, value, onChange, error, showForgot }) {
  ...
  return (
    <div>
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:7 }}>
        ...
        {showForgot && (
          <a href="#" style={{ fontSize:12, color:C.accent, textDecoration:"none", fontWeight:500 }}>Forgot password?</a>
        )}
      </div>
      <div style={{ position:"relative" }}>
        ...
        <button
          ...
          style={{
            ...
            color:C.muted, padding:2, lineHeight:1,
      ...
      <div style={{ minHeight:"100vh", background:C.bg, color:C.text, fontFamily:"'Sora', sans-serif", display:"flex", flexDirection:"column" }}>
        ...
        <nav style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"0 40px", height:62, borderBottom:`1px solid ${C.border}`, background:C.surface }}>
          ...
          <p style={{ fontSize:13, color:C.muted }}>
            ...
            <a href="/signup" style={{ color:C.accent, fontWeight:600, textDecoration:"none" }}>Sign up free</a>
          </p>
        </nav>
        ...
        <div style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", padding:"48px 24px" }}>
          <div style={{ width:"100%", maxWidth:440, animation:"fadeUp 0.5s ease" }}>
            ...
            <div style={{ textAlign:"center", marginBottom:36 }}>
              ...
              <h1 style={{ fontSize:32, fontWeight:900, letterSpacing:"-0.04em", marginBottom:10, color:C.text }}>Welcome back</h1>
            ...
            <div style={{ background:C.surface, border:`1px solid ${C.border}`, borderRadius:18, padding:"32px 32px 28px", boxShadow:"0 24px 60px rgba(0,0,0,0.5)" }}>
              ...
              <form onSubmit={handleSubmit} style={{ display:"flex", flexDirection:"column", gap:16 }}>
                ...
                <PasswordField label="Password" placeholder="Enter your password" value={form.password} onChange={update("password")} error={errors.password} showForgot />
