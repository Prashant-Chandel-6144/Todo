          ...
          <div style={{ width: "100%", maxWidth: 440 }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 36 }}>
              <div style={{
                ...
                background: `linear-gradient(135deg, ${C.accent}, #ff7c3a)`,
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: 24, boxShadow: `0 8px 24px ${C.accent}44`,
              }}>T</div>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 7 }}>
                    <label style={{ fontSize: 12, color: C.muted, fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase" }}>Password</label>
                    <a href="#" style={{ fontSize: 12, color: C.accent, textDecoration: "none", fontWeight: 500 }}>Forgot password?</a>
                  </div>
                  <Field type="password" placeholder="Enter your password" value={form.password} onChange={update("password")} error={errors.password} />
                </div>
